...
urlpatterns = [
    ...
    re_path(r'dj-rest-auth/registration/account-confirm-email/(?P<key>[-:\w]+)/$',
            TemplateView.as_view(template_name="registration/email_confirm.html"), name='account_confirm_email'),
    re_path(r'account-confirm-email/(?P<key>[-:\w]+)/$', CustomConfirmEmailView.as_view(),
            name='custom_account_confirm_email'),
]
